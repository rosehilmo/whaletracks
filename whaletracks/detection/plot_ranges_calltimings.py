...
df_calls=pd.read_csv('Marianas_Brydes_test_Oct16_10min.csv')
df_calls['peak_time']=pd.to_datetime(df_calls['peak_time'])


df1=pd.read_csv('stack_Marianas_Brydes_test_Oct16_10min.csv') 
...
t1=0
df1=pd.read_csv('auto_Marianas_Brydes_test_Oct16_10min.csv')  
...
saveranges.to_csv('Marianas_Brydes_test_Oct16_ranges.csv', index=False)
